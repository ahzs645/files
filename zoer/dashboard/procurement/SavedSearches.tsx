...
export function SavedSearches({ filters, onApply, onConfigureAlert, initialSearchId }: SavedSearchesProps) {
  ...
  return <section className="procurement-workflow" aria-label="Saved searches">
    <header><h2>Saved searches & deadlines</h2><p>Save the current source and filters, including closing in seven days. Deadline filters include only dates with a known timezone.</p></header>
    ...
    {!onConfigureAlert && <p className="procurement-coverage">Saved filters do not send notifications. Alert scheduling is not connected in this view.</p>}
